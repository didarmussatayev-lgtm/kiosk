...
public partial class Form1 : Form
{
    ...
    private static readonly Rectangle FixedBlockedZone = new Rectangle(1722, 0, 178, 75);
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (DebugBlockedZone)
        {
            ...
            e.Graphics.FillRectangle(debugBrush, FixedBlockedZone);
            using Pen debugPen = new Pen(Color.Red, 2);
            e.Graphics.DrawRectangle(debugPen, FixedBlockedZone);
        }
    }
    ...
    private static IntPtr MouseCallback(int nCode, IntPtr wParam, IntPtr lParam)
    {
        if (nCode >= 0 && wParam == (IntPtr)0x0201)
        {
            ...
            if (FixedBlockedZone.Contains(clickPoint))
                return (IntPtr)1;
        }
